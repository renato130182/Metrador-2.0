...
void contador1(){
  ...
  if(durationHigh >= 10){ //(microsegundos) tamanho do pulso 10 valor base limite 50Khz
    //Serial.println("PULSO VALIDO");
    pulsos1=pulsos1+1;
    countStopP1=0;
    p1=true;
    delay(2);  //(milisegundos) limita velocidade 2 valor base limite 500hz
  }  
}
...
//    }
  ...
  durationHigh = pulseIn(interruptPin1,HIGH,500000);
